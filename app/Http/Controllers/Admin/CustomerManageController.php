...
class CustomerManageController extends Controller
{
    ...
    public function edit($id){
        ...
        return view('backEnd.customer.edit',compact('edit_data', 'selectedImageMediaId'));
    }
    ...
    public function update(Request $request){
        ...
        $input = $request->except('hidden_id', 'image_media_id');
        ...
        if($image){
            $input['image'] = $this->fileUploadService->processAndUploadImage(
                $image,
                'uploads/customer',
                ['width' => 100, 'height' => 100, 'prefix' => 'customer']
            );
