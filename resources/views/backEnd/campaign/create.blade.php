                ...
                <form action="{{route('campaign.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12 my-3">
                        <div class="form-group">
                            ...
                            <textarea name="short_description" rows="6" class="campaign-builder-source form-control @error('short_description') is-invalid @enderror" data-builder-label="Short Description"></textarea>
                    ...
                    <div class="col-sm-12 my-3">
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="6" class="campaign-builder-source form-control @error('description') is-invalid @enderror" data-builder-label="Description"></textarea>
                    ...
                    <div class="col-sm-12 my-3">
                        <div class="form-group">
                            ...
                            <textarea name="why_chooseus" rows="6" class="campaign-builder-source form-control @error('why_chooseus') is-invalid @enderror" data-builder-label="Why Choose Us"></textarea>
