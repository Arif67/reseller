...
<div class="container-fluid">
    ...
    <div class="card"><div class="card-body">
        <form action="{{ route('hr.departments.update') }}" method="POST" class="row">
            @csrf
            ...
            <div class="col-12">
                <div class="form-group mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="4">{{ old('description', $edit_data->description) }}</textarea>
                </div>
            </div>
