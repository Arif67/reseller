                    ...
                    <table style="width:100%">
                        <tr>
                            <td style="width: 40%; float: left; padding-top: 15px;">
                                ...
                                <p style="font-size: 14px; color: #222; margin: 20px 0;"><strong>Payment Method:</strong> <span style="text-transform: uppercase;">{{$order->payment?->payment_method ?? ''}}</span></p>
                                <p style="font-size: 14px; color: #222; margin: 0 0 8px;"><strong>Payment Status:</strong> <span style="text-transform: uppercase;">{{$order->payment?->payment_status ?? 'pending'}}</span></p>
                                <p style="font-size: 14px; color: #222; margin: 0 0 8px;"><strong>Paid Amount:</strong> <span>৳{{ number_format($paidAmount, 2, '.', '') }}</span></p>
                                <p style="font-size: 14px; color: #222; margin: 0 0 8px;"><strong>Due Amount:</strong> <span>৳{{ number_format($dueAmount, 2, '.', '') }}</span></p>
                                @if ($changeAmount > 0)
                                    <p style="font-size: 14px; color: #222; margin: 0 0 20px;"><strong>Change:</strong> <span>৳{{ number_format($changeAmount, 2, '.', '') }}</span></p>
                                @endif
