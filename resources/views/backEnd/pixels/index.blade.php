        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('pixels.create')}}" class="btn btn-primary rounded-pill">Configure</a>
                </div>
                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $value->provider ?? 'facebook' }}</td>
                            <td>{{ $value->name ?? 'Default Pixel' }}</td>
                            <td>{{$value->code}}</td>
                            <td>
                                @if(!empty($value->access_token))
                                    <span class="badge bg-soft-success text-success">Configured</span>
                                @else
                                    <span class="badge bg-soft-warning text-warning">Missing Token</span>
                                @endif
                            </td>
