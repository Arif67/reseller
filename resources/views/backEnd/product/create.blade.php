...
<style>
  ...
  .variable-attribute-selector .select2-container {
    width: 100% !important;
  }
  ...
  .variable-attribute-selector .select2-container--default.select2-container--focus .select2-selection--multiple,
  .variable-attribute-selector .select2-container--default .select2-selection--multiple:hover {
    border-color: #60a5fa !important;
    box-shadow: 0 0 0 4px rgba(59, 130, 246, 0.12) !important;
  }

  .variable-attribute-selector .select2-container--default .select2-selection--multiple .select2-selection__choice {
  ...
  .variable-attribute-selector .select2-container--default .select2-search--inline .select2-search__field {
    margin-top: 6px !important;
    color: #0f172a;
  }

  .variable-attribute-selector .text-muted {
    display: block;
    margin-top: 10px;
  ...
  .product-create-form .product-gallery-box.product-gallery-box--feature {
    padding: 13px;
    border-style: solid;
    border-color: #bfdbfe;
    border-width: 1px;
  ...
  .product-create-form .product-gallery-title {
    display: block;
    margin-bottom: 5px;
    color: #0f172a;
    font-weight: 700;
  ...
  .product-create-form .product-gallery-note {
    display: block;
    margin-top: 6px;
    color: #64748b;
    font-size: 11px;
  ...
  .product-create-form .product-gallery-preview {
    display: grid;
  ...
  .product-create-form .product-gallery-preview-item {
    position: relative;
    width: 100%;
    aspect-ratio: 1 / 1;
    overflow: hidden;
  ...
  .product-create-form .product-gallery-preview-item img {
    width: 100%;
    height: 100%;
    object-fit: cover;
    display: block;
  ...
  .product-create-form .product-gallery-dropzone {
    position: relative;
    padding: 11px 10px;
  ...
  .product-create-form .product-gallery-dropzone.is-dragover {
    border-color: #2563eb;
    background: #dbeafe;
    transform: translateY(-1px);
  }

  .product-create-form .product-gallery-dropzone input[type=file] {
    position: absolute;
    inset: 0;
    width: 100%;
    height: 100%;
  ...
  .product-create-form .product-gallery-icon {
    width: 32px;
    height: 32px;
    margin: 0 auto 6px;
    border-radius: 10px;
  ...
  .product-create-form .product-gallery-dropzone strong {
    display: block;
    color: #0f172a;
    font-size: 12px;
    font-weight: 700;
  ...
  .product-create-form .product-gallery-dropzone span {
    display: block;
    margin-top: 3px;
    color: #64748b;
    font-size: 11px;
  ...
  .product-create-form .product-gallery-dropzone small {
    display: block;
    margin-top: 7px;
    color: #1d4ed8;
    font-size: 10px;
  ...
  .product-create-hero {
    ...
    padding: 24px;
    border-radius: 22px;
    background: linear-gradient(135deg, #ffeddc 0%, #fff7ef 34%, #fff 72%);
    border: 1px solid #ffd7b8;
    box-shadow: 0 30px 70px rgba(249, 115, 22, 0.14);
    margin-bottom: 24px;
  }
  ...
  .product-create-hero-actions .btn {
    border-radius: 999px;
    padding: 10px 18px;
    font-weight: 700;
  }
  ...
  <div class="row justify-content-center p-3">
    <div class="col-lg-12">
      <form action="{{route('products.store')}}" method="POST" class="row product-create-form" data-parsley-validate="" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group mb-3">
                      ...
                      <select class="form-control select2 @error('brand_id') is-invalid @enderror"
                        ...
                        <option value="{{$value->id}}" @selected(old('brand_id') == $value->id)>{{$value->name}}</option>
                        @endforeach
                      </select>
                      @error('brand_id')
                      <span class="invalid-feedback" role="alert">
                ...
                <div class="media-setup-grid">
                  <div class="media-side-panel">
                    ...
                    <div class="media-video-card">
                      <div class="form-group mb-0">
                        ...
                        <input type="url" class="form-control @error('pro_video') is-invalid @enderror" name="pro_video"
                          value="{{ old('pro_video') }}" id="pro_video" placeholder="https://www.youtube.com/watch?v=..." />
                        @error('pro_video')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
                  ...
                  <div class="product-gallery-box product-gallery-box--feature">
                    ...
                    <div class="product-gallery-dropzone">
                      ...
                      <small>Recommended: 1200 x 1500px (4:5), minimum 800 x 1000px, same ratio and clean background</small>
                  ...
                  <div class="media-type-panel">
                    ...
                    <div class="setup-choice-card">
                      <div class="form-group mb-0">
                        ...
                        <select class="form-control select2 @error('type') is-invalid @enderror" value="{{ old('type') }}"
                          id="product_type" name="type">
                          <option value="1">Normal Product</option>
                          <option value="0">Variation Product</option>
                        </select>
                        @error('type')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                    ...
                    <div class="media-setup-tip">
                      Selecting the product type first keeps the pricing area below cleaner.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="product-type-panel mb-3">
                  ...
                  <div class="variation-pricing-mode-wrap">
                    ...
                    <select class="form-control select2" id="variation_pricing_mode" name="variation_pricing_mode">
                      <option value="same" @selected(old('variation_pricing_mode', 'same') === 'same')>Same price for all variations</option>
                      <option value="different" @selected(old('variation_pricing_mode', 'same') === 'different')>Different price per variation</option>
                    </select>
                    <small class="variation-pricing-mode-hint">In same-price mode, you only need to enter the main pricing once. In different-price mode, each variation can have its own price.</small>
                  </div>
                </div>
                <div class="row">

            <div class="col-sm-12 variable-attribute-selector" style="display:none">
            ...
            <div class="normal_product shared_pricing_panel">
            ...
            <!-- normal product end -->
            <div class="variable_product product-pricing-grid" style="display:none">
              <div class="shared-variation-pricing-note">The main product price will apply to all variations. Use the rows below to manage stock and options.</div>
              <div class="row variable-row mb-3" data-row-index="0">
                @include('backEnd.product.partials.attribute-selects', [
                  'attributes' => $attributes,
                  'inputNamePrefix' => 'attribute_values[0]',
                  'selectedValues' => [],
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 variable-price-fields">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('purchase_prices') is-invalid @enderror" name="purchase_prices[0]" value="{{ old('purchase_prices.0') }}" />
                  </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4 variable-price-fields">
                  <div class="form-group">
                    <label for="old_prices" class="form-label">Old Price</label>
                    <input type="text" class="form-control @error('old_prices') is-invalid @enderror" name="old_prices[0]" value="{{ old('old_prices.0') }}" />
                  </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4 variable-price-fields">
                  <div class="form-group">
                    <label for="new_prices" class="form-label">New Price *</label>
                    <input type="text" class="form-control @error('new_prices') is-invalid @enderror" name="new_prices[0]" value="{{ old('new_prices.0') }}" />
                  </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4">
                  <div class="form-group">
                    <label for="stocks" class="form-label">Stock *</label>
                    <input type="text" class="form-control" name="stocks[0]" value="{{ old('stocks.0') }}">
                  </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                  <div class="form-group">
                    <label class="form-label">Variation Barcode</label>
                    <div class="input-group">
                      <input type="text" class="form-control @error('barcodes.0') is-invalid @enderror barcode-input" name="barcodes[0]" value="{{ old('barcodes.0') }}" placeholder="Scan or enter variation barcode" />
                      <button type="button" class="btn btn-outline-secondary barcode-generate-btn">Generate</button>
                    </div>
                  </div>
                </div>
                <div class="col-sm-12 mb-3">
                  <div class="variation-image-box">
                    <label for="images">Variation Images (optional)</label>
                    <div class="input-group control-group">
                      <input type="file" name="images[0][]" multiple accept="image/*" class="form-control @error('images.0.*') is-invalid @enderror" />
                    </div>
                    ...
                    @include('backEnd.product.partials.media-selector', [
                      ...
                      'inputName' => 'selected_variable_media_ids[0]',
                      'selectedIds' => $selectedVariableMediaIds[0] ?? [],
                      'mediaLibrary' => $mediaLibrary,
                    ])
              ...
              <div class="clone_variable" style="display:none">
                <div class="row variable-row increment_control mb-3" data-row-index="__INDEX__">
                  @include('backEnd.product.partials.attribute-selects', [
                    'attributes' => $attributes,
                  ...
                  <div class="col-lg-2 col-md-3 col-sm-4 variable-price-fields">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="purchase_prices[__INDEX__]" />
                    </div>
                  </div>
                  <div class="col-lg-2 col-md-3 col-sm-4 variable-price-fields">
                    <div class="form-group">
                      <label class="form-label">Old Price</label>
                      <input type="text" class="form-control" name="old_prices[__INDEX__]" />
                    </div>
                  </div>
                  <div class="col-lg-2 col-md-3 col-sm-4 variable-price-fields">
                    <div class="form-group">
                      <label class="form-label">New Price *</label>
                      <input type="text" class="form-control" name="new_prices[__INDEX__]" />
                    </div>
                  </div>
                  <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="form-group">
                      <label class="form-label">Stock *</label>
                      <input type="text" class="form-control" name="stocks[__INDEX__]" />
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="form-group">
                      <label class="form-label">Variation Barcode</label>
                      <div class="input-group">
                        <input type="text" class="form-control barcode-input" name="barcodes[__INDEX__]" placeholder="Scan or enter variation barcode" />
                        <button type="button" class="btn btn-outline-secondary barcode-generate-btn">Generate</button>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-12 mb-3">
                    <div class="variation-image-box">
                      ...
                      <div class="input-group control-group">
                        <input type="file" name="images[__INDEX__][]" multiple accept="image/*" class="form-control" />
                      </div>
                      <small class="variation-image-note">You can upload up to 2 images for each variation. Recommended size: 1200 x 1500px (4:5).</small>
                    @include('backEnd.product.partials.media-selector', [
                      'title' => 'Select Variation Media',
            ...
            <div class="col-sm-12 mb-3">
              <div class="form-group">
                ...
                <textarea name="care_tips" rows="6"
                  class="summernote form-control @error('care_tips') is-invalid @enderror" required></textarea>
                @error('care_tips')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
                  ...
                  <div class="product-seo-grid">
                    <div class="product-seo-fields">
                      <div class="product-seo-field-card">
                        ...
                        <div class="form-group mb-0">
                          ...
                          <input type="text" class="form-control @error('meta_title') is-invalid @enderror" name="meta_title" id="meta_title" value="{{ old('meta_title') }}" maxlength="255" placeholder="Write an SEO title">
                      ...
                      <div class="product-seo-field-card">
                        ...
                        <div class="form-group mb-3">
                          ...
                          <input type="text" class="form-control @error('meta_tag') is-invalid @enderror" name="meta_tag" id="meta_tag" value="{{ old('meta_tag') }}" placeholder="panjabi, cotton, men fashion">
                        ...
                        <div class="form-group mb-0">
                          ...
                          <textarea class="form-control @error('meta_description') is-invalid @enderror" name="meta_description" id="meta_description" rows="5" placeholder="Write the short description shown in search results">{{ old('meta_description') }}</textarea>
                    ...
                    <div class="product-seo-side">
                      <div class="product-seo-preview">
                        ...
                        <div class="product-seo-preview-title" id="seoPreviewTitle">{{ old('meta_title', old('name', 'Your product title will appear here')) }}</div>
                        <div class="product-seo-preview-url" id="seoPreviewUrl">{{ url('/product') }}/<span id="seoPreviewSlug">your-product-slug</span></div>
                        <p class="product-seo-preview-desc" id="seoPreviewDescription">{{ old('meta_description', 'A concise SEO description will help customers understand the product from search results.') }}</p>
            ...
            <div class="product-submit-bar">
              <div>
                ...
                <p>Review the form and save to create the product listing.</p>
              </div>
              <div class="text-end">
                <input type="submit" class="product-submit-btn" value="Create Product" />
              </div>
            </div>
          </form>
    </div>
...
<script>
  ...
  function toggleVariationPricingMode() {
    ...
    var pricingMode = $('#variation_pricing_mode').val() || 'same';
