                ...
                <div id="content-to-export" class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$value->name}}</td>
                             <td>{{$value->display_new_price}}</td>
                            <td>{{$value->report_stock}}</td>
                            <td>{{number_format((float) $value->report_total_value, 2, '.', '')}}</td>
                     ...
                     <tfoot>
                             <tr>
                                 ...
                                 <td><strong>{{$total_stock}} Pcs</strong></td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        @if($value->report_variables->isEmpty())
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                @foreach($value->report_variables as $variable)
                <tr>
                    <td>{{$value->name}}</td>
                    <td>{{$variable->size}}</td>
