...
@section('title', 'ভেন্ডর রেজিস্ট্রেশন | ' . ($generalsetting?->name ?? 'ShopBase BD'))
...
@section('content')
    <section class="auth-section">
        <div class="container">
            <div class="auth-card">
                @include('landing.partials._auth_tabs', ['active' => 'vendor', 'type' => 'register'])
                <h2>ভেন্ডর রেজিস্ট্রেশন</h2>
                ...
                <form method="POST" action="{{ route('vendor.store') }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            @error('shop_name')<span class="invalid-feedback"><strong>{{ $message }}</strong></span>@enderror
                        </div>
                    </div>
                ...
                <p class="auth-foot">আগে থেকেই অ্যাকাউন্ট আছে?
                    <a href="{{ route('vendor.login') }}">লগইন করুন</a>
                </p>
            </div>
        </div>
    </section>
